...
const MainSection = () => {
  return (
   ...
   <p data-aos="fade-up">Tuberculosis (TB) is the fourth leading cause of death in Kenya. Despite most forms of TB being curable,<br/> one of the main barriers to recovery includes lack of adherence to the long and complicated treatment regimens <br/> that involve the daily intake of medicines over the course of 6-24 months.</p>
